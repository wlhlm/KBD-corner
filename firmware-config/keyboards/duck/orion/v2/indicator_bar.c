 ...
 * ws2812_setleds and ws2812_init have to be redefined as they would otherwise
 * clash with the functions in the main driver. We give them a dummy name here.
 * The same approach is used by the work_louder keyboards.
 */
#undef WS2812_DI_PIN
#define WS2812_DI_PIN INDICATOR_BAR_PIN

#define ws2812_init dummy_ws2812_init
...
static void indicator_bar_showleds(void) {
    rgb_led_t indicator_leds_out[] = {{}, {}};

    // rgb_led_t is in GRB order
